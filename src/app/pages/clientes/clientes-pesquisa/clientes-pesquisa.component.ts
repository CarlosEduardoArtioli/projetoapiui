...
import { ClienteFiltro, ClientesService } from 'src/app/services/clientes.service';
  ...
  excluir(cliente: any) {
    this.clientesService.excluir(cliente.id)
      .then(() => {
        ...
        this.messageService.add({ severity: 'success', summary: 'Atenção', detail: 'Cliente excluido com sucesso' });
      })
