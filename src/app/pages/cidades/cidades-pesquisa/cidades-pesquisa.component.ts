...
import { CidadeFiltro, CidadesService } from '../../../services/cidades.service';
  ...
  excluir(cidade: any) {
    this.cidadesService.excluir(cidade.id)
      .then(() => {
        ...
        this.messageService.add({ severity: 'success', summary: 'Atenção', detail: 'Cidade excluida com sucesso' });
      })
